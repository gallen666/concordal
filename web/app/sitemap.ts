...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/research`,     lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${SITE}/cn-markets/block-trade`, lastModified: now, changeFrequency: "daily",   priority: 0.6 },
    { url: `${SITE}/hot/zt-pool`,            lastModified: now, changeFrequency: "daily",   priority: 0.7 },
    { url: `${SITE}/etf`,                    lastModified: now, changeFrequency: "daily",   priority: 0.6 },
    { url: `${SITE}/hk-markets`,             lastModified: now, changeFrequency: "daily",   priority: 0.6 },
    { url: `${SITE}/calendar`,               lastModified: now, changeFrequency: "daily",   priority: 0.6 },
    { url: `${SITE}/chain`,                  lastModified: now, changeFrequency: "weekly",  priority: 0.6 },
    { url: `${SITE}/report`,                 lastModified: now, changeFrequency: "weekly",  priority: 0.9 },
    { url: `${SITE}/report/600418`,          lastModified: now, changeFrequency: "weekly",  priority: 0.8 },
