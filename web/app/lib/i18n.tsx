...
const dict = {
  ...
  "disclaimer.body1":           {
    en: "Concordal is a research and decision-support tool. Outputs are generated by large language models on top of public market data, and may be wrong, stale, biased, or misleading.",
    zh: "Concordal 是一款研究与决策支持工具。其输出由大语言模型基于公开市场数据生成，可能出错、滞后、有偏见或具有误导性。",
  },
  "disclaimer.body2":           {
  ...
  "value.title":                {
    en: "Concordal isn't just a trading framework — it's the future of collaborative AI in finance.",
    zh: "Concordal 不仅是一个交易框架，更是 AI 协作智慧在金融领域的未来。",
  },
  ...
  "pricing.subheading":         {
    en: "Same 7-agent debate pipeline at every tier. Free: 5/day. Pro: more volume + persistent history. Pro+: priority queue + watchlist alerts. Institutional: dedicated audit DB + SSO + custom prompts — built for the SMB asset managers Bloomberg won't serve.",
    zh: "每一档跑的都是同一条 7-agent 辩证流水线。免费每日 5 次。Pro 升额度 + 持久化历史。Pro+ 优先队列 + 自选股提醒。Institutional 专属 audit DB + SSO + 定制 prompts，定位 Bloomberg 买不起的中端机构。",
  },
  ...
  "pricing.tier.enterprise":    { en: "Institutional",                      zh: "Institutional · 机构版" },
  "pricing.price.free":         { en: "$0",                                 zh: "¥0" },
  "pricing.price.pro":          { en: "$29 /mo",                            zh: "¥199 /月" },
  "pricing.price.proplus":      { en: "$127 /mo",                           zh: "¥899 /月" },
  "pricing.price.team":         { en: "$99 /mo",                            zh: "¥699 /月" },
  "pricing.price.enterprise":   { en: "$649 /mo",                           zh: "¥4,999 /月" },
  ...
  "pricing.price.suffix.enterprise":{ en: "Dedicated audit DB · SSO · custom prompts · legal SLA — for SMBs Bloomberg won't serve",  zh: "专属 audit DB · SSO · 定制 prompts · 法律 SLA — Bloomberg 买不起的中端机构" },
  ...
  "pricing.cta.enterprise":     { en: "Go Institutional",                   zh: "升级 Institutional" },
  ...
  "dev.heading":                { en: "Use Concordal as your backend",   zh: "把 Concordal 当你的后端" },
  "dev.subheading":             {
  ...
  "integrations.heading":       {
    en: "Use Concordal inside your favorite tools",
    zh: "在你常用的工具里直接使用 Concordal",
  },
  ...
  "integrations.openbb.step2":  {
    en: "Paste the URL above and give it a name (e.g. \"Concordal\").",
    zh: "把上面的 URL 粘贴进去，起个名字（例如 \"Concordal\"）。",
  },
  ...
  "how.heroBody":               {
    en: "Concordal gives each AI agent a specialized role, drives structured debate among them, and mirrors the workflow of an actual buy-side desk. We turn a chaotic single-prompt LLM into an organized, collaborative decision process.",
    zh: "Concordal 透过赋予 AI 智能体特定角色、促进结构化辩论，并模仿真实世界的工作流程，把混乱的单 prompt 互动转变为一个有组织、可协作的决策过程，旨在提高决策质量。",
  },
