...
app = FastAPI(
    ...
    description=(
        ...
        "See [/pricing](https://www.concordal.hk/pricing).\n\n"
...
def upgrade_checkout(
    ...
    site = os.environ.get("TA_SITE_URL", "https://www.concordal.hk")
    return {
...
def auth_magic_send(req: MagicLinkSendRequest, request: Request) -> dict:
    ...
    site_url = os.environ.get(
        "TA_SITE_URL", "https://www.concordal.hk",
    )
...
def _decision_to_markdown(payload: dict, share_id: str | None = None) -> str:
    ...
    lines.append("")
    lines.append("Generated by Concordal · www.concordal.hk")
    return "\n".join(lines)
