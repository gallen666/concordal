...
* **Decision sharing**: any user can mint a public, no-login `/d/<id>` URL for their just-finished decision. Useful for showing off (or arguing about) a specific call without having to log the recipient in.
